...
//			subids=subids+id+",";
//		}
//		subids=subids+ids[ids.length-1];
//		String deleteHQL = "delete  emp_info where 1 = 1 and id in (:id)";
//		System.out.println("delete from emp_info where 1 = 1 and ID in ("+subids+")");
//		session.getSession().createQuery(deleteHQL).setString("id", subids).executeUpdate();
