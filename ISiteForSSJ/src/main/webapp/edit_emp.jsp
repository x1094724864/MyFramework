...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/date_reset.css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/date_style.css" />
<!-- 以下 是自己添加的页面样式 -->
<style type="text/css">
span.item {
	font-style: green;
				...
				<form action="saveEmp" method="post" enctype="multipart/form-data">
					...
					<table align="center">
						...
						<tr>
							...
							<td>
								<div class="datepicker dpicker03" id="page4_jDateTimePicker1">
									<input type="text" id="page4_jDateTimePicker1_edit">
								</div>
